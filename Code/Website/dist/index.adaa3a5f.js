...
})({"46NiB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "7d126d63adaa3a5f";
"use strict";
...
},{}],"briMo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _utils = require("../node_modules/utils");
var data, dates;
...
function loadData(value) {
    while(section.lastElementChild)section.removeChild(section.lastElementChild);
        ...
        datasets: [
            {
                ...
                data: datapoints,
                borderColor: _utils.CHART_COLORS.green,
                fill: false,
...
},{"chart.js/auto":"d8NN9","../node_modules/utils":"aCUoB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"aCUoB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "srand", ()=>srand);
...
parcelHelpers.export(exports, "CHART_COLORS", ()=>CHART_COLORS);
parcelHelpers.export(exports, "namedColor", ()=>namedColor);
parcelHelpers.export(exports, "newDate", ()=>newDate);
parcelHelpers.export(exports, "newDateString", ()=>newDateString);
...
var _helpersJs = require("./chart.js/dist/helpers.js");
...
function rand(min, max) {
    min = (0, _helpersJs.valueOrDefault)(min, 0);
    max = (0, _helpersJs.valueOrDefault)(max, 0);
    _seed = (_seed * 9301 + 49297) % 233280;
    return min + _seed / 233280 * (max - min);
}
function numbers(config) {
    var cfg = config || {};
    var min = (0, _helpersJs.valueOrDefault)(cfg.min, 0);
    var max = (0, _helpersJs.valueOrDefault)(cfg.max, 100);
    var from = (0, _helpersJs.valueOrDefault)(cfg.from, []);
    var count = (0, _helpersJs.valueOrDefault)(cfg.count, 8);
    var decimals = (0, _helpersJs.valueOrDefault)(cfg.decimals, 8);
    var continuity = (0, _helpersJs.valueOrDefault)(cfg.continuity, 1);
    var dfactor = Math.pow(10, decimals) || 0;
    var data = [];
    var i, value;
    for(i = 0; i < count; ++i){
        value = (from[i] || 0) + this.rand(min, max);
        if (this.rand() <= continuity) data.push(Math.round(dfactor * value) / dfactor);
        else data.push(null);
    }
    return data;
}
...
function labels(config) {
    ...
    var values = [];
    var i;
    for(i = min; i < max; i += step)values.push(prefix + Math.round(dfactor * i) / dfactor);
    return values;
}
const MONTHS = [
    "January",
...
function transparentize(value, opacity) {
    ...
    return (0, _colorDefault.default)(value).alpha(alpha).rgbString();
}
const CHART_COLORS = {
    red: "rgb(255, 99, 132)",
...
function newDate(days) {
    return (0, _luxon.DateTime).now().plus({
        days
    }).toJSDate();
}
...
function parseISODate(str) {
    return (0, _luxon.DateTime).fromISO(str);
}

},{"@kurkle/color":"2aojw","luxon":"dpK6X","chartjs-adapter-luxon":"hmCSx","./chart.js/dist/helpers.js":"2ZYxS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dpK6X":[function(require,module,exports) {
"use strict";
...
},{}],"hmCSx":[function(require,module,exports) {
/*!
...
},{"chart.js":"ipU8D","luxon":"dpK6X"}],"2ZYxS":[function(require,module,exports) {
/*!
 * Chart.js v4.4.2
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":"2aojw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["46NiB","briMo"], "briMo", "parcelRequiref7a6")

//# sourceMappingURL=index.adaa3a5f.js.map
